...
dd_mraid.source = "mraid.js";

//lets set a flag whether this adunit is MRAID compliant or not
...
if (is_mraid && mraid.getState() == "loading") mraid.addEventListener("ready", dd_mraid_ready); else dd_richmedia_ready();

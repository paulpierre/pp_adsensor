...
class Browser
{
    ...
    /*********/
    const BROWSER_CRAWLER_GOOGLEADS         = 'Google Ads Bot';
    const BROWSER_CRAWLER_GOOGLEPREVIEW = 'Google Preview';
    const BROWSER_CRAWLER_BINGPREVIEW   ='Bing Preview';
    const BROWSER_CRAWLER_MSNBOT    ='MSN Bot';
    const BROWSER_CRAWLER_360SPIDER ='360 Spider';
    const BROWSER_CRAWLER_APPLEBOT = 'Apple Inc.';
    const BROWSER_CRAWLER_BAIDU ='Baidu';
    const BROWSER_CRAWLER_YANDEX = 'Yandex';


    const BROWSER_UTILITY_CURL              = 'curl';
    const BROWSER_UTILITY_WGET              = 'wget';
    const BROWSER_UTILITY_AHC               ='ahc';
    const BROWSER_UTILITY_ANYEVENT          = 'anyevent-http';
    const BROWSER_UTILITY_GO1               = 'go 1';
    const BROWSER_UTILITY_W3CVALIDATOR      = 'w3c_validator';
    const BROWSER_UTILITY_WDGVALIDATOR      = 'wdg_validator';
    const BROWSER_UTILITY_GOOGLELIB         = 'google-http';
    const BROWSER_UTILITY_OKHTTP            = 'okhttp';
    const BROWSER_UTILITY_PCORE             = 'pcore';
    const BROWSER_UTILITY_PEARHTTP           =  'pear http';

    const BROWSER_UTILITY_GENERIC_HTTP_1     = 'http client';
    const BROWSER_UTILITY_GENERIC_HTTP_2     = 'http-client';
    const BROWSER_UTILITY_GENERIC_HTTP_3     = 'http_client';
    const BROWSER_UTILITY_GENERIC_HTTP_4     = 'httpclient';
    const BROWSER_UTILITY_GENERIC_HTTP_5     = 'http_request';
    const BROWSER_UTILITY_GENERIC_HTTP_6     = 'http-request';
    const BROWSER_UTILITY_GENERIC_HTTP_7     = 'httprequest';
    const BROWSER_UTILITY_GENERIC_HTTP_8     = 'http_transport';
    const BROWSER_UTILITY_GENERIC_HTTP_9     = 'http-transport';
    const BROWSER_UTILITY_GENERIC_HTTP_10    = 'httptransport';
    const BROWSER_UTILITY_GENERIC_HTTP_JAVA    = 'java';
    const BROWSER_UTILITY_GENERIC_HTTP_PHP    = 'php-';
    const BROWSER_UTILITY_GENERIC_HTTP_PERL    = 'perl';
    const BROWSER_UTILITY_GENERIC_HTTP_PYTHON   = 'python';

    const BROWSER_BOT_GENERIC_1                 = ' bot'    ;
    const BROWSER_BOT_GENERIC_2                 = '-bot'    ;
    const BROWSER_BOT_GENERIC_3                 = '_bot'    ;
    const BROWSER_BOT_GENERIC_4                 = 'crawl'   ;
    const BROWSER_BOT_GENERIC_5                 = 'download';
    const BROWSER_BOT_GENERIC_6                 = 'fetch'   ;
    const BROWSER_BOT_GENERIC_7                 = 'link'    ;
    const BROWSER_BOT_GENERIC_8                 = 'robot'   ;
    const BROWSER_BOT_GENERIC_9                 = 'scanner' ;
    const BROWSER_BOT_GENERIC_10                = 'scrape'  ;
    const BROWSER_BOT_GENERIC_11                = 'seobot'  ;
    const BROWSER_BOT_GENERIC_12                = 'seo '    ;
    const BROWSER_BOT_GENERIC_13                = 'seo_'    ;
    const BROWSER_BOT_GENERIC_14                = 'seo-'    ;
    const BROWSER_BOT_GENERIC_15                = 'sitemap' ;
    const BROWSER_BOT_GENERIC_16                = 'spider'  ;
    const BROWSER_BOT_GENERIC_17                = 'webbot'  ;

    const BROWSER_APP_GOOGLEDOCS                    = 'Google Docs Bot';
    const BROWSER_APP_FACEBOOK_BOT = 'Facebook Bot';
    const BROWSER_APP_PINTEREST = 'Pinterest';
    const BROWSER_APP_SLACK_1 = 'slackbot';
    const BROWSER_APP_SLACK_2 = 'slack.com';
    const BROWSER_APP_TELEGRAM_BOT = 'Telegram Bot';
    const BROWSER_APP_TWITTER_BOT = 'Twitter Bot';
    const BROWSER_APP_PINGDOM = 'pingdom';
    const BROWSER_APP_FACEBOOK = 'Facebook App';
    const BROWSER_APP_TWITTER = 'Twitter';
    ...
    protected function checkGenericBots()
    {

        $generic_bots = Array(
            Array(self::BROWSER_UTILITY_CURL, 'curl'),
            Array(self::BROWSER_UTILITY_WGET              , 'wget'),
            Array(self::BROWSER_UTILITY_AHC               ,'ahc'),
            Array(self::BROWSER_UTILITY_ANYEVENT          , 'anyevent-http'),
            Array(self::BROWSER_UTILITY_GO1               , 'go 1'),
            Array(self::BROWSER_UTILITY_W3CVALIDATOR      , 'w3c_validator'),
            Array(self::BROWSER_UTILITY_WDGVALIDATOR      , 'wdg_validator'),
            Array(self::BROWSER_UTILITY_GOOGLELIB         , 'google-http'),
            Array(self::BROWSER_UTILITY_OKHTTP            , 'okhttp'),
            Array(self::BROWSER_UTILITY_PCORE             , 'pcore'),
            Array(self::BROWSER_UTILITY_PEARHTTP           ,  'pear http'),

            Array(self::BROWSER_UTILITY_GENERIC_HTTP_1     , 'http client'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_2     , 'http-client'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_3     , 'http_client'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_4     , 'httpclient'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_5     , 'http_request'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_6     , 'http-request'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_7     , 'httprequest'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_8     , 'http_transport'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_9     , 'http-transport'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_10    , 'httptransport'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_JAVA    , 'java'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_PHP    , 'php-'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_PERL    , 'perl'),
            Array(self::BROWSER_UTILITY_GENERIC_HTTP_PYTHON   , 'python'),

            Array(self::BROWSER_BOT_GENERIC_1                 , ' bot'    ),
            Array(self::BROWSER_BOT_GENERIC_2                 , '-bot'    ),
            Array(self::BROWSER_BOT_GENERIC_3                 , '_bot'    ),
            Array(self::BROWSER_BOT_GENERIC_4                 , 'crawl'   ),
            Array(self::BROWSER_BOT_GENERIC_5                 , 'download'),
            Array(self::BROWSER_BOT_GENERIC_6                 , 'fetch'   ),
            Array(self::BROWSER_BOT_GENERIC_7                 , 'link'    ),
            Array(self::BROWSER_BOT_GENERIC_8                 , 'robot'   ),
            Array(self::BROWSER_BOT_GENERIC_9                 , 'scanner' ),
            Array(self::BROWSER_BOT_GENERIC_10                , 'scrape'  ),
            Array(self::BROWSER_BOT_GENERIC_11                , 'seobot'  ),
            Array(self::BROWSER_BOT_GENERIC_12                , 'seo '    ),
            Array(self::BROWSER_BOT_GENERIC_13                , 'seo_'    ),
            Array(self::BROWSER_BOT_GENERIC_14                , 'seo-'    ),
            Array(self::BROWSER_BOT_GENERIC_15                , 'sitemap' ),
            Array(self::BROWSER_BOT_GENERIC_16                , 'spider'  ),
            Array(self::BROWSER_BOT_GENERIC_17                , 'webbot'  )
        );

        foreach($generic_bots as $bot)
        {
            if($this->checkSimpleBrowserUA($bot[1], $this->_agent, $bot[0], false, true)) return true;
            else continue;
        }
    ...
    protected function checkBrowserBingbot()
    {
        return ($this->checkSimpleBrowserUA('bingbot', $this->_agent, self::BROWSER_BINGBOT, false, true) ||
            $this->checkSimpleBrowserUA('bingpreview', $this->_agent, self::BROWSER_CRAWLER_BINGPREVIEW, false, true));
    }

    protected function check360Bot()
    {
        return $this->checkSimpleBrowserUA('360spider', $this->_agent, self::BROWSER_CRAWLER_360SPIDER, false, true);
    }

    protected function checkAppleBot()
    {
        return $this->checkSimpleBrowserUA('applebot', $this->_agent, self::BROWSER_CRAWLER_APPLEBOT, false, true);
    }

    protected function checkBaiduBot()
    {
        return $this->checkSimpleBrowserUA('baidu', $this->_agent, self::BROWSER_CRAWLER_BAIDU, false, true);
    }

    protected function checkYandexBot()
    {
        return $this->checkSimpleBrowserUA('yandex', $this->_agent, self::BROWSER_CRAWLER_YANDEX, false, true);
    }

    protected function checkFacebookBot()
    {
        return $this->checkSimpleBrowserUA('facebookexternalhit', $this->_agent, self::BROWSER_APP_FACEBOOK_BOT, false, true);
    }

    protected function checkTwitterBot()
    {
        return $this->checkSimpleBrowserUA('twitterbot', $this->_agent, self::BROWSER_APP_TWITTER_BOT, false, true);
    }

    protected function checkFacebookBrowser()
    {
        return $this->checkSimpleBrowserUA('FBAV', $this->_agent, self::BROWSER_APP_FACEBOOK, true, false);
    }

    protected function checkTwitterBrowser()
    {
        return ($this->checkSimpleBrowserUA('Twitter for', $this->_agent, self::BROWSER_APP_TWITTER, true, false) ||
            $this->checkSimpleBrowserUA('TwitterAndroid', $this->_agent, self::BROWSER_APP_TWITTER, true, false));
    }
    ...
    protected function checkBrowserGooglebot()
    {
        if ($this->checkSimpleBrowserUA('Googlebot', $this->_agent, self::BROWSER_GOOGLEBOT, false, true) ||
            $this->checkSimpleBrowserUA('google web preview', $this->_agent, self::BROWSER_CRAWLER_GOOGLEPREVIEW, false, true) ||
            $this->checkSimpleBrowserUA('googledocs', $this->_agent, self::BROWSER_APP_GOOGLEDOCS, false, true) ||
            $this->checkSimpleBrowserUA('adsbot-google', $this->_agent, self::BROWSER_CRAWLER_GOOGLEADS, false, true)
    ...
    protected function checkBrowsers()
    {
        ...
        return
            ...
            $this->checkFacebookBrowser() ||
            $this->checkTwitterBrowser() ||
            /* Mobile */
